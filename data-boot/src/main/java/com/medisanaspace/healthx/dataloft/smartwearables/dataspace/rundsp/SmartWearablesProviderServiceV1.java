...
@GrpcService
@Slf4j
public class SmartWearablesProviderServiceV1 extends ProviderServiceGrpc.ProviderServiceImplBase {
    ...
    public SmartWearablesProviderServiceV1(UserDataService userDataService, ActivityService activityService, PublicationService publicationService) {
    ...
    private static PublishInfo createPublishInfoFor(Publication publication) {
        return PublishInfo.newBuilder()
                .setAuthenticationType(publication.getAuthenticationType())
