 ...
 * </pre>
 *
 * Protobuf type {@code dsp.v1alpha2.GetDatasetRequest}
 */
public final class GetDatasetRequest extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:dsp.v1alpha2.GetDatasetRequest)
...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return ProviderProto.internal_static_dsp_v1alpha2_GetDatasetRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return ProviderProto.internal_static_dsp_v1alpha2_GetDatasetRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            GetDatasetRequest.class, Builder.class);
  }
  ...
  public static GetDatasetRequest parseFrom(
  ...
  public static GetDatasetRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static GetDatasetRequest parseFrom(
  ...
  public static GetDatasetRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static GetDatasetRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static GetDatasetRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(GetDatasetRequest prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:dsp.v1alpha2.GetDatasetRequest)
      GetDatasetRequestOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return ProviderProto.internal_static_dsp_v1alpha2_GetDatasetRequest_descriptor;
    ...
    // Construct using com.dsp.v1alpha2.GetDatasetRequest.newBuilder()
    private Builder() {
    ...
    @Override
    public GetDatasetRequest getDefaultInstanceForType() {
      return GetDatasetRequest.getDefaultInstance();
    }

    @Override
    public GetDatasetRequest build() {
      GetDatasetRequest result = buildPartial();
    ...
    @Override
    public GetDatasetRequest buildPartial() {
      GetDatasetRequest result = new GetDatasetRequest(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(GetDatasetRequest result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof GetDatasetRequest) {
        return mergeFrom((GetDatasetRequest)other);
      } else {
    ...
    public Builder mergeFrom(GetDatasetRequest other) {
      if (other == GetDatasetRequest.getDefaultInstance()) return this;
    ...
    // @@protoc_insertion_point(builder_scope:dsp.v1alpha2.GetDatasetRequest)
  }

  // @@protoc_insertion_point(class_scope:dsp.v1alpha2.GetDatasetRequest)
  private static final GetDatasetRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new GetDatasetRequest();
  }
