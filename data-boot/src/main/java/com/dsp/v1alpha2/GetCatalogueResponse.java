 ...
 * </pre>
 *
 * Protobuf type {@code dsp.v1alpha2.GetCatalogueResponse}
 */
public final class GetCatalogueResponse extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:dsp.v1alpha2.GetCatalogueResponse)
...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return ProviderProto.internal_static_dsp_v1alpha2_GetCatalogueResponse_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return ProviderProto.internal_static_dsp_v1alpha2_GetCatalogueResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            GetCatalogueResponse.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof GetCatalogueResponse)) {
      return super.equals(obj);
    }
    GetCatalogueResponse other = (GetCatalogueResponse) obj;
  ...
  public static GetCatalogueResponse parseFrom(
  ...
  public static GetCatalogueResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static GetCatalogueResponse parseFrom(
  ...
  public static GetCatalogueResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static GetCatalogueResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static GetCatalogueResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(GetCatalogueResponse prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:dsp.v1alpha2.GetCatalogueResponse)
      GetCatalogueResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return ProviderProto.internal_static_dsp_v1alpha2_GetCatalogueResponse_descriptor;
    ...
    // Construct using com.dsp.v1alpha2.GetCatalogueResponse.newBuilder()
    private Builder() {
    ...
    @Override
    public GetCatalogueResponse getDefaultInstanceForType() {
      return GetCatalogueResponse.getDefaultInstance();
    }

    @Override
    public GetCatalogueResponse build() {
      GetCatalogueResponse result = buildPartial();
    ...
    @Override
    public GetCatalogueResponse buildPartial() {
      GetCatalogueResponse result = new GetCatalogueResponse(this);
    ...
    private void buildPartialRepeatedFields(GetCatalogueResponse result) {
      if (datasetsBuilder_ == null) {
    ...
    private void buildPartial0(GetCatalogueResponse result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof GetCatalogueResponse) {
        return mergeFrom((GetCatalogueResponse)other);
      } else {
    ...
    public Builder mergeFrom(GetCatalogueResponse other) {
      if (other == GetCatalogueResponse.getDefaultInstance()) return this;
      if (datasetsBuilder_ == null) {
    ...
    // @@protoc_insertion_point(builder_scope:dsp.v1alpha2.GetCatalogueResponse)
  }

  // @@protoc_insertion_point(class_scope:dsp.v1alpha2.GetCatalogueResponse)
  private static final GetCatalogueResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new GetCatalogueResponse();
  }

  public static GetCatalogueResponse getDefaultInstance() {
